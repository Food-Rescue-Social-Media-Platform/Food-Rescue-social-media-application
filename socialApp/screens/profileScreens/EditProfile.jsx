...
const EditProfile = ({ navigation, route }) => {
  ...
  const [userProfileCover, setUserProfileCover] = useState(
    userData?.profileCover || require("../../assets/Images/cover.png"),
  );
  const [userProfileImage, setUserProfileImage] = useState(
    userData?.profileImg || require("../../assets/Images/emptyProfieImage.png"),
  );
  ...
  const updateUserProfile = async () => {
    try {
      ...
      const coverURL = await uploadImages(
        userProfileCover,
        "usersCoverImages/",
        "image",
      );
  ...
  return (
    ...
    >
      <ScrollView>
        ...
        >
          <Text style={[styles.panelButtonTitle, { color: theme.primaryText }]}>
            Submit
          </Text>
        </TouchableOpacity>
      </ScrollView>
